...
type ImageGeneration struct {
	...
	VideoPrompt       *string               `gorm:"type:text" json:"video_prompt,omitempty"`              // 视频生成提示词
	VideoPromptStatus string                `gorm:"size:20;default:'pending'" json:"video_prompt_status"` // 视频提示词生成状态: pending, processing, completed, failed
